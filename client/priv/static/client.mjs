...
// build/dev/javascript/client/client/header.mjs
function header() {
  return nav(
...
function get_route2() {
  let uri = (() => {
    ...
    if ($2.isOk()) {
      ...
      throw makeError("panic", "client", 110, "get_route", "Invalid uri", {});
    }
  })();
  let $ = (() => {
    let _pipe = uri.path;
...
function main() {
  let _pipe = application(init3, update, view4);
