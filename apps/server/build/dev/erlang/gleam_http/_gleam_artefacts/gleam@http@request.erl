...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 31).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 45).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 76).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 87).
-spec set_header(request(IPN), binary(), binary()) -> request(IPN).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 104).
-spec prepend_header(request(IPQ), binary(), binary()) -> request(IPQ).
prepend_header(Request, Key, Value) ->
    Headers = [{gleam@string:lowercase(Key), Value} |
        erlang:element(3, Request)],
    erlang:setelement(3, Request, Headers).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 116).
-spec set_body(request(any()), IPV) -> request(IPV).
set_body(Req, Body) ->
    {request, Method, Headers, _, Scheme, Host, Port, Path, Query} = Req,
    {request, Method, Headers, Body, Scheme, Host, Port, Path, Query}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 141).
-spec map(request(IPX), fun((IPX) -> IPZ)) -> request(IPZ).
map(Request, Transform) ->
    _pipe = erlang:element(4, Request),
    _pipe@1 = Transform(_pipe),
    set_body(Request, _pipe@1).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 161).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 167).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 177).
-spec set_query(request(IQJ), list({binary(), binary()})) -> request(IQJ).
set_query(Req, Query) ->
    Pair = fun(T) ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 200).
-spec set_method(request(IQN), gleam@http:method()) -> request(IQN).
set_method(Req, Method) ->
    erlang:setelement(2, Req, Method).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 207).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 222).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 230).
-spec set_scheme(request(IQU), gleam@http:scheme()) -> request(IQU).
set_scheme(Req, Scheme) ->
    erlang:setelement(5, Req, Scheme).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 236).
-spec set_host(request(IQX), binary()) -> request(IQX).
set_host(Req, Host) ->
    erlang:setelement(6, Req, Host).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 242).
-spec set_port(request(IRA), integer()) -> request(IRA).
set_port(Req, Port) ->
    erlang:setelement(7, Req, {some, Port}).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 248).
-spec set_path(request(IRD), binary()) -> request(IRD).
set_path(Req, Path) ->
    erlang:setelement(8, Req, Path).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 255).
-spec set_cookie(request(IRG), binary(), binary()) -> request(IRG).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 274).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_http/src/gleam/http/request.gleam", 292).
-spec remove_cookie(request(IRL), binary()) -> request(IRL).
