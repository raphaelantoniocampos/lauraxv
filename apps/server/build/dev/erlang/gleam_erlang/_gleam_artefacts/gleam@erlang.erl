...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 10).
-spec format(any()) -> binary().
format(Term) ->
    unicode:characters_to_binary(io_lib:format(<<"~p"/utf8>>, [Term])).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 20).
-spec term_to_binary(any()) -> bitstring().
term_to_binary(A) ->
    erlang:term_to_binary(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 73).
-spec get_line(binary()) -> {ok, binary()} | {error, get_line_error()}.
get_line(Prompt) ->
    gleam_erlang_ffi:get_line(Prompt).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 86).
-spec system_time(time_unit()) -> integer().
system_time(A) ->
    os:system_time(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 92).
-spec erlang_timestamp() -> {integer(), integer(), integer()}.
erlang_timestamp() ->
    os:timestamp().

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 102).
-spec rescue(fun(() -> FWI)) -> {ok, FWI} | {error, crash()}.
rescue(A) ->
    gleam_erlang_ffi:rescue(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 34).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 49).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 117).
-spec start_arguments() -> list(binary()).
start_arguments() ->
    _pipe = init:get_plain_arguments(),
    gleam@list:map(_pipe, fun unicode:characters_to_binary/1).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 140).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 163).
-spec make_reference() -> reference_().
make_reference() ->
    erlang:make_ref().

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_erlang/src/gleam/erlang.gleam", 178).
