...
-export([frame_to_bytes_builder/2, compressed_frame_to_bytes_builder/3, to_text_frame/3, to_binary_frame/3, aggregate_frames/3, frame_from_message/2, get_messages/3, has_deflate/1, parse_websocket_key/1]).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 30).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 204).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 212).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 242).
-spec make_frame(
    integer(),
    integer(),
    bitstring(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 165).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 184).
-spec compressed_frame_to_bytes_builder(
    frame(),
    gramps@websocket@compression:context(),
    gleam@option:option(bitstring())
) -> gleam@bytes_builder:bytes_builder().
compressed_frame_to_bytes_builder(Frame, Context, Mask) ->
    case Frame of
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 269).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 279).
-spec to_text_frame(
    binary(),
...
to_text_frame(Data, Context, Mask) ->
    ...
    case Context of
        {some, Context@1} ->
            compressed_frame_to_bytes_builder(Frame, Context@1, Mask);

        _ ->
            frame_to_bytes_builder(Frame, Mask)
    end.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 297).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 327).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 343).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 389).
-spec inflate(
    boolean(),
    gleam@option:option(gramps@websocket@compression:context()),
    bitstring()
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 63).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 314).
-spec get_messages(
    bitstring(),
    list(parsed_frame()),
    gleam@option:option(gramps@websocket@compression:context())
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 405).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gramps/src/gramps/websocket.gleam", 376).
