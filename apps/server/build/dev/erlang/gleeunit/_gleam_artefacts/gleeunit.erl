...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleeunit/src/gleeunit.gleam", 50).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleeunit/src/gleeunit.gleam", 27).
-spec do_main() -> nil.
do_main() ->
    Options = [verbose,
        no_tty,
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleeunit/src/gleeunit.gleam", 9).
-spec main() -> nil.
main() ->
    do_main().
