...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 124).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 221).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 250).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 270).
-spec file_info(binary()) -> {ok, file_info()} | {error, file_error()}.
file_info(Filepath) ->
    simplifile_erl:file_info(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 280).
-spec link_info(binary()) -> {ok, file_info()} | {error, file_error()}.
link_info(Filepath) ->
    simplifile_erl:link_info(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 324).
-spec delete(binary()) -> {ok, nil} | {error, file_error()}.
delete(Path) ->
    simplifile_erl:delete(Path).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 331).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 365).
-spec read_bits(binary()) -> {ok, bitstring()} | {error, file_error()}.
read_bits(Filepath) ->
    simplifile_erl:read_bits(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 288).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 375).
-spec write_bits(binary(), bitstring()) -> {ok, nil} | {error, file_error()}.
write_bits(Filepath, Bits) ->
    simplifile_erl:write_bits(Filepath, Bits).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 306).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 388).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 349).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 402).
-spec is_directory(binary()) -> {ok, boolean()} | {error, file_error()}.
is_directory(Filepath) ->
    simplifile_erl:is_directory(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 413).
-spec create_directory(binary()) -> {ok, nil} | {error, file_error()}.
create_directory(Filepath) ->
    simplifile_erl:create_directory(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 423).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 438).
-spec read_directory(binary()) -> {ok, list(binary())} | {error, file_error()}.
read_directory(Path) ->
    simplifile_erl:read_directory(Path).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 450).
-spec is_file(binary()) -> {ok, boolean()} | {error, file_error()}.
is_file(Filepath) ->
    simplifile_erl:is_file(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 462).
-spec is_symlink(binary()) -> {ok, boolean()} | {error, file_error()}.
is_symlink(Filepath) ->
    simplifile_erl:is_symlink(Filepath).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 467).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 478).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 497).
-spec copy_file(binary(), binary()) -> {ok, nil} | {error, file_error()}.
copy_file(Src, Dest) ->
    _pipe = file:copy(Src, Dest),
    gleam@result:replace(_pipe, nil).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 510).
-spec rename_file(binary(), binary()) -> {ok, nil} | {error, file_error()}.
rename_file(Src, Dest) ->
    simplifile_erl:rename_file(Src, Dest).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 521).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 513).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 554).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 564).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 574).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 597).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 605).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 629).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 644).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 226).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 680).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 665).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/simplifile/src/simplifile.gleam", 688).
