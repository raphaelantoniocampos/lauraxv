...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 16).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 11).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 24).
-spec get_env(binary()) -> binary().
get_env(Var) ->
    gleam@result:unwrap(envoy_ffi:get(Var), <<""/utf8>>).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 28).
-spec home_dir_path(binary()) -> binary().
home_dir_path(Path) ->
    <<(get_env(<<"HOME"/utf8>>))/binary, Path/binary>>.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 32).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 48).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 74).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 94).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 115).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 137).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 151).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 166).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 178).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 202).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 214).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 234).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/directories/src/directories.gleam", 247).
