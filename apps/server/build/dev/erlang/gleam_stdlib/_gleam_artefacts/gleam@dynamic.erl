...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 29).
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 38).
-spec unsafe_coerce(dynamic_()) -> any().
unsafe_coerce(A) ->
    gleam_stdlib:identity(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 52).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 73).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 120).
-spec put_expected(decode_error(), binary()) -> decode_error().
put_expected(Error, Expected) ->
    erlang:setelement(2, Error, Expected).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 131).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 154).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 177).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 200).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 226).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 369).
-spec optional(fun((dynamic_()) -> {ok, DOM} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DOM)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 504).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1034).
-spec any(list(fun((dynamic_()) -> {ok, DSM} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        DSM} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1530).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1067).
-spec decode1(
    fun((DSQ) -> DSR),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 576).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 261).
-spec result(
    fun((dynamic_()) -> {ok, DOA} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DOC} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, DOA} | {error, DOC}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 314).
-spec list(fun((dynamic_()) -> {ok, DOH} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DOH)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 100).
-spec map_errors(
    {ok, DMV} | {error, list(decode_error())},
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 108).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 96).
-spec string(dynamic_()) -> {ok, binary()} | {error, list(decode_error())}.
string(Data) ->
    decode_string(Data).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 398).
-spec field(
    any(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 440).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DPA} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DPA)} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 483).
-spec element(
    integer(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 566).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 642).
-spec tuple2(
    fun((dynamic_()) -> {ok, DQI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DQK} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DQI, DQK}} | {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 711).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {DQN, DQP, DQR}} | {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 782).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {DQU, DQW, DQY, DRA}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 855).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {DRD, DRF, DRH, DRJ, DRL}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 930).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {DRO, DRQ, DRS, DRU, DRW, DRY}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 981).
-spec dict(
    fun((dynamic_()) -> {ok, DSB} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DSD} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(DSB, DSD)} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1095).
-spec decode2(
    fun((DSU, DSV) -> DSW),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1127).
-spec decode3(
    fun((DTA, DTB, DTC) -> DTD),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1173).
-spec decode4(
    fun((DTI, DTJ, DTK, DTL) -> DTM),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1229).
-spec decode5(
    fun((DTS, DTT, DTU, DTV, DTW) -> DTX),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1289).
-spec decode6(
    fun((DUE, DUF, DUG, DUH, DUI, DUJ) -> DUK),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1354).
-spec decode7(
    fun((DUS, DUT, DUU, DUV, DUW, DUX, DUY) -> DUZ),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1423).
-spec decode8(
    fun((DVI, DVJ, DVK, DVL, DVM, DVN, DVO, DVP) -> DVQ),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1496).
-spec decode9(
    fun((DWA, DWB, DWC, DWD, DWE, DWF, DWG, DWH, DWI) -> DWJ),
