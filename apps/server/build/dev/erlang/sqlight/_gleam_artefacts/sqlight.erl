...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 125).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 215).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 336).
-spec open(binary()) -> {ok, connection()} | {error, error()}.
open(Path) ->
    sqlight_ffi:open(Path).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 346).
-spec close(connection()) -> {ok, nil} | {error, error()}.
close(Connection) ->
    sqlight_ffi:close(Connection).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 367).
-spec with_connection(binary(), fun((connection()) -> YPV)) -> YPV.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 374).
-spec exec(binary(), connection()) -> {ok, nil} | {error, error()}.
exec(Sql, Connection) ->
    sqlight_ffi:exec(Sql, Connection).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 421).
-spec int(integer()) -> value().
int(Value) ->
    sqlight_ffi:coerce_value(Value).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 428).
-spec float(float()) -> value().
float(Value) ->
    sqlight_ffi:coerce_value(Value).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 435).
-spec text(binary()) -> value().
text(Value) ->
    sqlight_ffi:coerce_value(Value).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 444).
-spec blob(bitstring()) -> value().
blob(Value) ->
    sqlight_ffi:coerce_blob(Value).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 454).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 465).
-spec null() -> value().
null() ->
    sqlight_ffi:null().

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 411).
-spec nullable(fun((YQL) -> value()), gleam@option:option(YQL)) -> value().
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 471).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 479).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/sqlight/src/sqlight.gleam", 378).
-spec 'query'(
    binary(),
    connection(),
    list(value()),
    fun((gleam@dynamic:dynamic_()) -> {ok, YPZ} |
        {error, list(gleam@dynamic:decode_error())})
) -> {ok, list(YPZ)} | {error, error()}.
