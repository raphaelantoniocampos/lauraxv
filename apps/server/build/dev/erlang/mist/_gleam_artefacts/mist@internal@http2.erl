...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 30).
-spec default_settings() -> http2_settings().
default_settings() ->
    {http2_settings, 4096, disabled, 100, 65535, 16384, none}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 41).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 93).
-spec send_data(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 115).
-spec send_frame(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 154).
-spec hpack_new_context(integer()) -> hpack_context().
hpack_new_context(Size) ->
    hpack:new_context(Size).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 157).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 165).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 171).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 62).
-spec send_headers(
    hpack_context(),
    mist@internal@http:connection(),
    list({binary(), binary()}),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2.gleam", 125).
...
send_bytes_builder(Resp, Conn, Context, Id) ->
    Resp@1 = begin
        _pipe = Resp,
        mist@internal@http:add_default_headers(_pipe, false, false)
    end,
    Headers = [{<<":status"/utf8>>,
