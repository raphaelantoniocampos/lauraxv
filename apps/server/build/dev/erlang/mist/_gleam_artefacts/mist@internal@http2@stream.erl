...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/stream.gleam", 148).
-spec make_request(
    list({binary(), binary()}),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/stream.gleam", 56).
-spec new(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/stream.gleam", 201).
