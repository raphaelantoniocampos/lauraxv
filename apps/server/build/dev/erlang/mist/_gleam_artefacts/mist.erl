...
-opaque builder(OLH, OLI) :: {builder,
        integer(),
        fun((gleam@http@request:request(OLH)) -> gleam@http@response:response(OLI)),
...
-type websocket_message(OLJ) :: {text, binary()} |
    {binary, bitstring()} |
    closed |
    shutdown |
    {custom, OLJ}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 70).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 84).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 114).
-spec read_body(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 143).
-spec do_stream(
    gleam@http@request:request(mist@internal@http:connection()),
    mist@internal@buffer:buffer()
) -> fun((integer()) -> {ok, chunk()} | {error, read_error()}).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 208).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 188).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 260).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 309).
-spec new(
    fun((gleam@http@request:request(OME)) -> gleam@http@response:response(OMG))
) -> builder(OME, OMG).
new(Handler) ->
    {builder,
        4000,
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 321).
-spec port(builder(OMK, OML), integer()) -> builder(OMK, OML).
port(Builder, Port) ->
    erlang:setelement(2, Builder, Port).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 328).
-spec read_request_body(
    builder(bitstring(), OMQ),
    integer(),
    gleam@http@response:response(OMQ)
) -> builder(mist@internal@http:connection(), OMQ).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 344).
-spec after_start(
    builder(OMW, OMX),
    fun((integer(), gleam@http:scheme()) -> nil)
) -> builder(OMW, OMX).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 351).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 365).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 397).
-spec start_https(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 434).
-spec internal_to_public_ws_message(
    mist@internal@websocket:handler_message(ONO)
) -> {ok, websocket_message(ONO)} | {error, nil}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 459).
-spec websocket(
    gleam@http@request:request(mist@internal@http:connection()),
    fun((ONU, mist@internal@websocket:websocket_connection(), websocket_message(ONV)) -> gleam@otp@actor:next(ONV, ONU)),
    fun((mist@internal@websocket:websocket_connection()) -> {ONU,
        gleam@option:option(gleam@erlang@process:selector(ONV))}),
    fun((ONU) -> nil)
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 512).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 536).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 574).
-spec event(gleam@string_builder:string_builder()) -> sse_event().
event(Data) ->
    {sse_event, none, none, Data}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 579).
-spec event_id(sse_event(), binary()) -> sse_event().
event_id(Event, Id) ->
    erlang:setelement(2, Event, {some, Id}).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 584).
-spec event_name(sse_event(), binary()) -> sse_event().
event_name(Event, Name) ->
    erlang:setelement(3, Event, {some, Name}).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 597).
-spec server_sent_events(
    gleam@http@request:request(mist@internal@http:connection()),
    gleam@http@response:response(any()),
    fun(() -> gleam@otp@actor:init_result(OOJ, OOK)),
    fun((OOK, sse_connection(), OOJ) -> gleam@otp@actor:next(OOK, OOJ))
) -> gleam@http@response:response(response_data()).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist.gleam", 642).
