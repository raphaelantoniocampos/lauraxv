...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 27).
-spec initial_state() -> state().
initial_state() ->
    {state, none}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 60).
-spec log_and_error(
    gleam@erlang:crash(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 84).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 132).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 178).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 195).
-spec int_to_hex(integer()) -> binary().
int_to_hex(Int) ->
    erlang:integer_to_list(Int, 16).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 104).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http/handler.gleam", 31).
-spec call(
    gleam@http@request:request(mist@internal@http:connection()),
