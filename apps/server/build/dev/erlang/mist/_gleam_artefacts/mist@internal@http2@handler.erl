...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/handler.gleam", 44).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/handler.gleam", 48).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/handler.gleam", 52).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/handler.gleam", 56).
-spec upgrade(
    bitstring(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/handler.gleam", 118).
-spec handle_frame(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/mist/src/mist/internal/http2/handler.gleam", 91).
-spec call(
    state(),
    mist@internal@http:connection(),
    fun((gleam@http@request:request(mist@internal@http:connection())) -> gleam@http@response:response(mist@internal@http:response_data()))
