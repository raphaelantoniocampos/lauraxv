...
-export([controlling_process/2, accept_timeout/2, accept/1, receive_timeout/3, 'receive'/2, send/2, socket_info/1, close/1, do_shutdown/2, shutdown/1, set_opts/2, listen/2, handshake/1, negotiated_protocol/1, peername/1]).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 11).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 20).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 26).
-spec accept(glisten@socket:listen_socket()) -> {ok, glisten@socket:socket()} |
    {error, glisten@socket:socket_reason()}.
accept(Socket) ->
    gen_tcp:accept(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 29).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 36).
-spec 'receive'(glisten@socket:socket(), integer()) -> {ok, bitstring()} |
    {error, glisten@socket:socket_reason()}.
'receive'(Socket, Length) ->
    gen_tcp:recv(Socket, Length).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 39).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 42).
-spec socket_info(glisten@socket:socket()) -> gleam@dict:dict(any(), any()).
socket_info(Socket) ->
    socket:info(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 45).
-spec close(any()) -> {ok, nil} | {error, glisten@socket:socket_reason()}.
close(Socket) ->
    glisten_tcp_ffi:close(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 48).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 50).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 59).
-spec set_opts(
    glisten@socket:socket(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 68).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 77).
-spec handshake(glisten@socket:socket()) -> {ok, glisten@socket:socket()} |
    {error, nil}.
handshake(Socket) ->
    {ok, Socket}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 82).
-spec negotiated_protocol(glisten@socket:socket()) -> any().
negotiated_protocol(Socket) ->
    tcp:negotiated_protocol(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/tcp.gleam", 85).
