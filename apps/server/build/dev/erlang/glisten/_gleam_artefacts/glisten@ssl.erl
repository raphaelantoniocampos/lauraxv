...
-export([controlling_process/2, accept_timeout/2, accept/1, receive_timeout/3, 'receive'/2, send/2, close/1, do_shutdown/2, shutdown/1, set_opts/2, handshake/1, listen/2, negotiated_protocol/1, peername/1, start/0]).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 11).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 20).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 26).
-spec accept(glisten@socket:listen_socket()) -> {ok, glisten@socket:socket()} |
    {error, glisten@socket:socket_reason()}.
accept(Socket) ->
    ssl:transport_accept(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 29).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 36).
-spec 'receive'(glisten@socket:socket(), integer()) -> {ok, bitstring()} |
    {error, glisten@socket:socket_reason()}.
'receive'(Socket, Length) ->
    ssl:recv(Socket, Length).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 39).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 42).
-spec close(glisten@socket:socket()) -> {ok, nil} |
    {error, glisten@socket:socket_reason()}.
close(Socket) ->
    glisten_ssl_ffi:close(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 45).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 47).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 56).
-spec set_opts(
    glisten@socket:socket(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 68).
-spec handshake(glisten@socket:socket()) -> {ok, glisten@socket:socket()} |
    {error, nil}.
handshake(Socket) ->
    ssl:handshake(Socket).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 71).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 81).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 84).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/glisten/src/glisten/ssl.gleam", 87).
