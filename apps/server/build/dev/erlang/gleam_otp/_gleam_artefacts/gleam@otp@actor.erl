...
-type message(JEB) :: {message, JEB} |
    {system, gleam@otp@system:system_message()} |
    {unexpected, gleam@dynamic:dynamic_()}.

-type next(JEC, JED) :: {continue,
        JED,
        gleam@option:option(gleam@erlang@process:selector(JEC))} |
    {stop, gleam@erlang@process:exit_reason()}.

-type init_result(JEE, JEF) :: {ready, JEE, gleam@erlang@process:selector(JEF)} |
    {failed, binary()}.

-type self(JEG, JEH) :: {self,
        gleam@otp@system:mode(),
        gleam@erlang@process:pid_(),
        JEG,
        gleam@erlang@process:subject(JEH),
        gleam@erlang@process:selector(message(JEH)),
        gleam@otp@system:debug_state(),
        fun((JEH, JEG) -> next(JEH, JEG))}.

-type spec(JEI, JEJ) :: {spec,
        fun(() -> init_result(JEI, JEJ)),
        integer(),
        fun((JEJ, JEI) -> next(JEJ, JEI))}.

-type start_error() :: init_timeout |
    {init_failed, gleam@erlang@process:exit_reason()} |
    {init_crashed, gleam@dynamic:dynamic_()}.

-type start_init_message(JEK) :: {ack,
        {ok, gleam@erlang@process:subject(JEK)} |
            {error, gleam@erlang@process:exit_reason()}} |
    {mon, gleam@erlang@process:process_down()}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 178).
-spec continue(JER) -> next(any(), JER).
continue(State) ->
    {continue, State, none}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 186).
-spec with_selector(next(JEV, JEW), gleam@erlang@process:selector(JEV)) -> next(JEV, JEW).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 259).
-spec exit_process(gleam@erlang@process:exit_reason()) -> gleam@erlang@process:exit_reason().
exit_process(Reason) ->
    Reason.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 295).
-spec selecting_system_messages(gleam@erlang@process:selector(message(JFH))) -> gleam@erlang@process:selector(message(JFH)).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 264).
-spec receive_message(self(any(), JFD)) -> message(JFD).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 308).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 415).
-spec init_selector(
    gleam@erlang@process:subject(JJV),
    gleam@erlang@process:selector(JJV)
) -> gleam@erlang@process:selector(message(JJV)).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 318).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 374).
-spec initialise_actor(
    spec(any(), JFY),
    gleam@erlang@process:subject({ok, gleam@erlang@process:subject(JFY)} |
        {error, gleam@erlang@process:exit_reason()})
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 444).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 466).
-spec start_spec(spec(any(), JGL)) -> {ok, gleam@erlang@process:subject(JGL)} |
    {error, start_error()}.
start_spec(Spec) ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 514).
-spec start(JGR, fun((JGS, JGR) -> next(JGS, JGR))) -> {ok,
        gleam@erlang@process:subject(JGS)} |
    {error, start_error()}.
start(State, Loop) ->
    start_spec(
        {spec,
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 529).
-spec send(gleam@erlang@process:subject(JGY), JGY) -> nil.
send(Subject, Msg) ->
    gleam@erlang@process:send(Subject, Msg).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/actor.gleam", 542).
-spec call(
    gleam@erlang@process:subject(JHA),
    fun((gleam@erlang@process:subject(JHC)) -> JHA),
    integer()
) -> JHC.
