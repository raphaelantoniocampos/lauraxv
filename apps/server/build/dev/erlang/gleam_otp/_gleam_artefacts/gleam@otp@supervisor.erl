...
-type spec(JSR, JSS) :: {spec,
        JSR,
        integer(),
        integer(),
        fun((children(JSR)) -> children(JSS))}.

-opaque children(JST) :: {ready, starter(JST)} | {failed, child_start_error()}.

-opaque child_spec(JSU, JSV, JSW) :: {child_spec,
        fun((JSV) -> {ok, gleam@erlang@process:subject(JSU)} |
            {error, gleam@otp@actor:start_error()}),
        fun((JSV, gleam@erlang@process:subject(JSU)) -> JSW)}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 87).
-spec start_child(child_spec(any(), JTD, JTE), JTD) -> {ok, child(JTE)} |
    {error, child_start_error()}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 106).
-spec shutdown_child(
    gleam@erlang@process:pid_(),
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 110).
-spec perform_instruction_for_child(
    JTR,
    instruction(),
    child_spec(any(), JTR, JTT),
    child(JTT)
) -> {ok, {child(JTT), instruction()}} | {error, child_start_error()}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 132).
-spec add_child_to_starter(
    starter(JUB),
    child_spec(any(), JUB, JUE),
    child(JUE)
) -> starter(JUE).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 164).
-spec start_and_add_child(starter(JUK), child_spec(any(), JUK, JUN)) -> children(JUN).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 178).
-spec add(children(JUS), child_spec(any(), JUS, JUV)) -> children(JUV).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 206).
-spec supervisor(
    fun((JVA) -> {ok, gleam@erlang@process:subject(JVB)} |
        {error, gleam@otp@actor:start_error()})
) -> child_spec(JVB, JVA, JVA).
supervisor(Start) ->
    {child_spec, Start, fun(Argument, _) -> Argument end}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 228).
-spec worker(
    fun((JVI) -> {ok, gleam@erlang@process:subject(JVJ)} |
        {error, gleam@otp@actor:start_error()})
) -> child_spec(JVJ, JVI, JVI).
worker(Start) ->
    {child_spec, Start, fun(Argument, _) -> Argument end}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 241).
-spec returning(
    child_spec(JVQ, JVR, any()),
    fun((JVR, gleam@erlang@process:subject(JVQ)) -> JVX)
) -> child_spec(JVQ, JVR, JVX).
returning(Child, Updater) ->
    {child_spec, erlang:element(2, Child), Updater}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 248).
-spec init(spec(any(), JWC)) -> gleam@otp@actor:init_result(state(JWC), message()).
init(Spec) ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 305).
-spec handle_exit(gleam@erlang@process:pid_(), state(JWI)) -> gleam@otp@actor:next(message(), state(JWI)).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 345).
-spec loop(message(), state(JWN)) -> gleam@otp@actor:next(message(), state(JWN)).
loop(Message, State) ->
    case Message of
        {exit, Exit_message} ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 377).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 408).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 438).
-spec application_stopped() -> application_stop().
application_stopped() ->
    gleam_otp_external:application_stopped().

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 457).
