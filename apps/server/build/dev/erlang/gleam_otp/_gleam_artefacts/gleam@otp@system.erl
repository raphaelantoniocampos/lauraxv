...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/system.gleam", 19).
-spec debug_state(list(debug_option())) -> debug_state().
debug_state(A) ->
    sys:debug_options(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/system.gleam", 65).
-spec get_state(gleam@erlang@process:pid_()) -> gleam@dynamic:dynamic_().
get_state(From) ->
    sys:get_state(From).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/system.gleam", 77).
-spec suspend(gleam@erlang@process:pid_()) -> nil.
suspend(Pid) ->
    sys:suspend(Pid),
    nil.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_otp/src/gleam/otp/system.gleam", 92).
