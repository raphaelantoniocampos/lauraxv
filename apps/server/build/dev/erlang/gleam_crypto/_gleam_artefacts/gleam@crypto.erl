...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 20).
-spec strong_random_bytes(integer()) -> bitstring().
strong_random_bytes(A) ->
    crypto:strong_rand_bytes(A).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 40).
-spec hash(hash_algorithm(), bitstring()) -> bitstring().
hash(A, B) ->
    gleam_crypto_ffi:hash(A, B).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 51).
-spec hmac(bitstring(), hash_algorithm(), bitstring()) -> bitstring().
hmac(Data, Algorithm, Key) ->
    gleam_crypto_ffi:hmac(Data, Algorithm, Key).

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 64).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 57).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 94).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 83).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/gleam_crypto/src/gleam/crypto.gleam", 114).
