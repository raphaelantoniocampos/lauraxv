...
-type element(TFC) :: {text, binary()} |
    {element,
        ...
        boolean()} |
    {map, fun(() -> element(TFC))} |
    {fragment, list(element(TFC)), binary()}.

-type attribute(TFD) :: {attribute,
        binary(),
        gleam@dynamic:dynamic_(),
        boolean()} |
    {event,
        binary(),
        fun((gleam@dynamic:dynamic_()) -> {ok, TFD} |
            {error, list(gleam@dynamic:decode_error())})}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 389).
-spec attribute_to_event_handler(attribute(TGY)) -> {ok,
        {binary(),
            fun((gleam@dynamic:dynamic_()) -> {ok, TGY} |
                {error, list(gleam@dynamic:decode_error())})}} |
    {error, nil}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 112).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 352).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 281).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 269).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 192).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 182).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 188).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 104).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 79).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 67).
-spec do_element_list_handlers(
    list(element(TFR)),
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, TFR} |
        {error, list(gleam@dynamic:decode_error())})),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, TFR} |
    {error, list(gleam@dynamic:decode_error())})).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 43).
-spec do_handlers(
    element(TFJ),
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, TFJ} |
        {error, list(gleam@dynamic:decode_error())})),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, TFJ} |
    {error, list(gleam@dynamic:decode_error())})).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/vdom.gleam", 39).
-spec handlers(element(TFE)) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok,
        TFE} |
    {error, list(gleam@dynamic:decode_error())})).
handlers(Element) ->
