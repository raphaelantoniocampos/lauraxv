...
-type patch(UDF) :: {diff, element_diff(UDF)} |
    {emit, binary(), gleam@json:json()} |
    {init, list(binary()), lustre@internals@vdom:element(UDF)}.

-type element_diff(UDG) :: {element_diff,
        gleam@dict:dict(binary(), lustre@internals@vdom:element(UDG)),
        gleam@set:set(binary()),
        gleam@dict:dict(binary(), attribute_diff(UDG)),
        gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, UDG} |
            {error, list(gleam@dynamic:decode_error())}))}.

-type attribute_diff(UDH) :: {attribute_diff,
        gleam@set:set(lustre@internals@vdom:attribute(UDH)),
        gleam@set:set(binary()),
        gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, UDH} |
            {error, list(gleam@dynamic:decode_error())}))}.

-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 188).
-spec do_attribute(
    attribute_diff(UEG),
    binary(),
    {ok, lustre@internals@vdom:attribute(UEG)} | {error, nil},
    {ok, lustre@internals@vdom:attribute(UEG)} | {error, nil}
) -> attribute_diff(UEG).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 291).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 287).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 309).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 327).
-spec zip(list(UEX), list(UEX)) -> list({gleam@option:option(UEX),
    gleam@option:option(UEX)}).
zip(Xs, Ys) ->
    case {Xs, Ys} of
        {[], []} ->
            [];
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 378).
-spec event_handler(lustre@internals@vdom:attribute(UFJ)) -> {ok,
        {binary(),
            fun((gleam@dynamic:dynamic_()) -> {ok, UFJ} |
                {error, list(gleam@dynamic:decode_error())})}} |
    {error, nil}.
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 427).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 433).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 240).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 218).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 343).
-spec attribute_dict(list(lustre@internals@vdom:attribute(UFD))) -> gleam@dict:dict(binary(), lustre@internals@vdom:attribute(UFD)).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 165).
-spec attributes(
    list(lustre@internals@vdom:attribute(UEA)),
    list(lustre@internals@vdom:attribute(UEA))
) -> attribute_diff(UEA).
attributes(Old, New) ->
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 150).
-spec do_element_list(
    element_diff(UDT),
    list(lustre@internals@vdom:element(UDT)),
    list(lustre@internals@vdom:element(UDT)),
    binary()
) -> element_diff(UDT).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 54).
-spec do_elements(
    element_diff(UDM),
    gleam@option:option(lustre@internals@vdom:element(UDM)),
    gleam@option:option(lustre@internals@vdom:element(UDM)),
    binary()
) -> element_diff(UDM).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 45).
-spec elements(
    lustre@internals@vdom:element(UDI),
    lustre@internals@vdom:element(UDI)
) -> element_diff(UDI).
elements(Old, New) ->
    do_elements(
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 416).
-spec fold_element_list_event_handlers(
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, UFW} |
        {error, list(gleam@dynamic:decode_error())})),
    list(lustre@internals@vdom:element(UFW)),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, UFW} |
    {error, list(gleam@dynamic:decode_error())})).
...
-file("/home/raphaelac/repositories/lauraxv/server/build/packages/lustre/src/lustre/internals/patch.gleam", 391).
-spec fold_event_handlers(
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, UFO} |
        {error, list(gleam@dynamic:decode_error())})),
    lustre@internals@vdom:element(UFO),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, UFO} |
    {error, list(gleam@dynamic:decode_error())})).
