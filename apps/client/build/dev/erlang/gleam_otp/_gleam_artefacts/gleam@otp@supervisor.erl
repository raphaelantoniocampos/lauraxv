...
-type spec(LZV, LZW) :: {spec,
        LZV,
        integer(),
        integer(),
        fun((children(LZV)) -> children(LZW))}.

-opaque children(LZX) :: {ready, starter(LZX)} | {failed, child_start_error()}.

-opaque child_spec(LZY, LZZ, MAA) :: {child_spec,
        fun((LZZ) -> {ok, gleam@erlang@process:subject(LZY)} |
            {error, gleam@otp@actor:start_error()}),
        fun((LZZ, gleam@erlang@process:subject(LZY)) -> MAA)}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 87).
-spec start_child(child_spec(any(), MAH, MAI), MAH) -> {ok, child(MAI)} |
    {error, child_start_error()}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 106).
-spec shutdown_child(
    gleam@erlang@process:pid_(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 110).
-spec perform_instruction_for_child(
    MAV,
    instruction(),
    child_spec(any(), MAV, MAX),
    child(MAX)
) -> {ok, {child(MAX), instruction()}} | {error, child_start_error()}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 132).
-spec add_child_to_starter(
    starter(MBF),
    child_spec(any(), MBF, MBI),
    child(MBI)
) -> starter(MBI).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 164).
-spec start_and_add_child(starter(MBO), child_spec(any(), MBO, MBR)) -> children(MBR).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 178).
-spec add(children(MBW), child_spec(any(), MBW, MBZ)) -> children(MBZ).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 206).
-spec supervisor(
    fun((MCE) -> {ok, gleam@erlang@process:subject(MCF)} |
        {error, gleam@otp@actor:start_error()})
) -> child_spec(MCF, MCE, MCE).
supervisor(Start) ->
    {child_spec, Start, fun(Argument, _) -> Argument end}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 228).
-spec worker(
    fun((MCM) -> {ok, gleam@erlang@process:subject(MCN)} |
        {error, gleam@otp@actor:start_error()})
) -> child_spec(MCN, MCM, MCM).
worker(Start) ->
    {child_spec, Start, fun(Argument, _) -> Argument end}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 241).
-spec returning(
    child_spec(MCU, MCV, any()),
    fun((MCV, gleam@erlang@process:subject(MCU)) -> MDB)
) -> child_spec(MCU, MCV, MDB).
returning(Child, Updater) ->
    {child_spec, erlang:element(2, Child), Updater}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 248).
-spec init(spec(any(), MDG)) -> gleam@otp@actor:init_result(state(MDG), message()).
init(Spec) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 305).
-spec handle_exit(gleam@erlang@process:pid_(), state(MDM)) -> gleam@otp@actor:next(message(), state(MDM)).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 345).
-spec loop(message(), state(MDR)) -> gleam@otp@actor:next(message(), state(MDR)).
loop(Message, State) ->
    case Message of
        {exit, Exit_message} ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 377).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 408).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 438).
-spec application_stopped() -> application_stop().
application_stopped() ->
    gleam_otp_external:application_stopped().

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_otp/src/gleam/otp/supervisor.gleam", 457).
