...
-type element(RFW) :: {text, binary()} |
    {element,
        ...
        boolean()} |
    {map, fun(() -> element(RFW))} |
    {fragment, list(element(RFW)), binary()}.

-type attribute(RFX) :: {attribute,
        binary(),
        gleam@dynamic:dynamic_(),
        boolean()} |
    {event,
        binary(),
        fun((gleam@dynamic:dynamic_()) -> {ok, RFX} |
            {error, list(gleam@dynamic:decode_error())})}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 389).
-spec attribute_to_event_handler(attribute(RHS)) -> {ok,
        {binary(),
            fun((gleam@dynamic:dynamic_()) -> {ok, RHS} |
                {error, list(gleam@dynamic:decode_error())})}} |
    {error, nil}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 112).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 352).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 281).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 269).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 192).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 182).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 188).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 104).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 79).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 67).
-spec do_element_list_handlers(
    list(element(RGL)),
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, RGL} |
        {error, list(gleam@dynamic:decode_error())})),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, RGL} |
    {error, list(gleam@dynamic:decode_error())})).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 43).
-spec do_handlers(
    element(RGD),
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, RGD} |
        {error, list(gleam@dynamic:decode_error())})),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, RGD} |
    {error, list(gleam@dynamic:decode_error())})).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/vdom.gleam", 39).
-spec handlers(element(RFY)) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok,
        RFY} |
    {error, list(gleam@dynamic:decode_error())})).
handlers(Element) ->
