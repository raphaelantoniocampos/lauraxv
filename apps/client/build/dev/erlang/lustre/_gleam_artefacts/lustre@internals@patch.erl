...
-type patch(SDZ) :: {diff, element_diff(SDZ)} |
    {emit, binary(), gleam@json:json()} |
    {init, list(binary()), lustre@internals@vdom:element(SDZ)}.

-type element_diff(SEA) :: {element_diff,
        gleam@dict:dict(binary(), lustre@internals@vdom:element(SEA)),
        gleam@set:set(binary()),
        gleam@dict:dict(binary(), attribute_diff(SEA)),
        gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, SEA} |
            {error, list(gleam@dynamic:decode_error())}))}.

-type attribute_diff(SEB) :: {attribute_diff,
        gleam@set:set(lustre@internals@vdom:attribute(SEB)),
        gleam@set:set(binary()),
        gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, SEB} |
            {error, list(gleam@dynamic:decode_error())}))}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 188).
-spec do_attribute(
    attribute_diff(SFA),
    binary(),
    {ok, lustre@internals@vdom:attribute(SFA)} | {error, nil},
    {ok, lustre@internals@vdom:attribute(SFA)} | {error, nil}
) -> attribute_diff(SFA).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 291).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 287).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 309).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 327).
-spec zip(list(SFR), list(SFR)) -> list({gleam@option:option(SFR),
    gleam@option:option(SFR)}).
zip(Xs, Ys) ->
    case {Xs, Ys} of
        {[], []} ->
            [];
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 378).
-spec event_handler(lustre@internals@vdom:attribute(SGD)) -> {ok,
        {binary(),
            fun((gleam@dynamic:dynamic_()) -> {ok, SGD} |
                {error, list(gleam@dynamic:decode_error())})}} |
    {error, nil}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 427).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 433).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 240).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 218).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 343).
-spec attribute_dict(list(lustre@internals@vdom:attribute(SFX))) -> gleam@dict:dict(binary(), lustre@internals@vdom:attribute(SFX)).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 165).
-spec attributes(
    list(lustre@internals@vdom:attribute(SEU)),
    list(lustre@internals@vdom:attribute(SEU))
) -> attribute_diff(SEU).
attributes(Old, New) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 150).
-spec do_element_list(
    element_diff(SEN),
    list(lustre@internals@vdom:element(SEN)),
    list(lustre@internals@vdom:element(SEN)),
    binary()
) -> element_diff(SEN).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 54).
-spec do_elements(
    element_diff(SEG),
    gleam@option:option(lustre@internals@vdom:element(SEG)),
    gleam@option:option(lustre@internals@vdom:element(SEG)),
    binary()
) -> element_diff(SEG).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 45).
-spec elements(
    lustre@internals@vdom:element(SEC),
    lustre@internals@vdom:element(SEC)
) -> element_diff(SEC).
elements(Old, New) ->
    do_elements(
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 416).
-spec fold_element_list_event_handlers(
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, SGQ} |
        {error, list(gleam@dynamic:decode_error())})),
    list(lustre@internals@vdom:element(SGQ)),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, SGQ} |
    {error, list(gleam@dynamic:decode_error())})).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/internals/patch.gleam", 391).
-spec fold_event_handlers(
    gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, SGI} |
        {error, list(gleam@dynamic:decode_error())})),
    lustre@internals@vdom:element(SGI),
    binary()
) -> gleam@dict:dict(binary(), fun((gleam@dynamic:dynamic_()) -> {ok, SGI} |
    {error, list(gleam@dynamic:decode_error())})).
