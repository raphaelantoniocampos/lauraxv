...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 101).
-spec component(list(lustre@internals@vdom:attribute(VXF))) -> lustre@internals@vdom:element(VXF).
component(Attrs) ->
    lustre@element:element(<<"lustre-server-component"/utf8>>, Attrs, []).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 107).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 123).
-spec route(binary()) -> lustre@internals@vdom:attribute(any()).
route(Path) ->
    lustre@attribute:attribute(<<"route"/utf8>>, Path).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 134).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 170).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 182).
-spec subscribe(binary(), fun((lustre@internals@patch:patch(VXS)) -> nil)) -> lustre@internals@runtime:action(VXS, lustre:server_component()).
subscribe(Id, Renderer) ->
    {subscribe, Id, Renderer}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 192).
-spec unsubscribe(binary()) -> lustre@internals@runtime:action(any(), lustre:server_component()).
unsubscribe(Id) ->
    {unsubscribe, Id}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 206).
-spec emit(binary(), gleam@json:json()) -> lustre@effect:effect(any()).
emit(Event, Data) ->
    lustre@effect:event(Event, Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 236).
-spec do_select(
    fun((fun((VYG) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(VYG))
) -> lustre@effect:effect(VYG).
do_select(Sel) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 229).
-spec select(
    fun((fun((VYB) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(VYB))
) -> lustre@effect:effect(VYB).
select(Sel) ->
    do_select(Sel).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 257).
-spec set_selector(
    gleam@erlang@process:selector(lustre@internals@runtime:action(any(), VYM))
) -> lustre@effect:effect(VYM).
set_selector(_) ->
    lustre@effect:from(
        fun(_) ->
            _pipe = <<"
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 283).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 321).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 304).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 277).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre/src/lustre/server_component.gleam", 331).
