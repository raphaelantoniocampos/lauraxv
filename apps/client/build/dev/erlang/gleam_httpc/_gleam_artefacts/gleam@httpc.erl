...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 69).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 74).
-spec string_header({charlist(), charlist()}) -> {binary(), binary()}.
string_header(Header) ->
    {K, V} = Header,
    {erlang:list_to_binary(K), erlang:list_to_binary(V)}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 92).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 149).
-spec configure() -> configuration().
configure() ->
    {builder, true}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 84).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 162).
-spec verify_tls(configuration(), boolean()) -> configuration().
verify_tls(_, Which) ->
    {builder, Which}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 168).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_httpc/src/gleam/httpc.gleam", 186).
