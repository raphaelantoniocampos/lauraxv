...
-export_type([transport/0, ip_address/0]).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 17).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 28).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 39).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 50).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 60).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 67).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 79).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 90).
-spec send(
    transport(),
    glisten@socket:socket(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 101).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 108).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 118).
-spec set_opts(
    transport(),
    glisten@socket:socket(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 129).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 144).
-spec decode_ipv4() -> fun((gleam@dynamic:dynamic_()) -> {ok, ip_address()} |
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 154).
-spec decode_ipv6() -> fun((gleam@dynamic:dynamic_()) -> {ok, ip_address()} |
    {error, list(gleam@dynamic:decode_error())}).
decode_ipv6() ->
    fun(Dyn) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 178).
-spec decode_ip() -> fun((gleam@dynamic:dynamic_()) -> {ok, ip_address()} |
    {error, list(gleam@dynamic:decode_error())}).
decode_ip() ->
    gleam@dynamic:any([decode_ipv6(), decode_ipv4()]).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 182).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 202).
-spec socket_info(glisten@socket:socket()) -> gleam@dict:dict(gleam@erlang@atom:atom_(), gleam@dynamic:dynamic_()).
socket_info(Socket) ->
    socket:info(Socket).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 204).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 215).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/transport.gleam", 228).
