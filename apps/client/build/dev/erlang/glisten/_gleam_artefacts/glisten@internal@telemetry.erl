...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/telemetry.gleam", 42).
-spec log(
    list(event()),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/telemetry.gleam", 60).
-spec span(
    list(event()),
    gleam@dict:dict(binary(), gleam@dynamic:dynamic_()),
    fun(() -> QMM)
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/telemetry.gleam", 77).
-spec attach_many(
    binary(),
    list(list(event())),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/telemetry.gleam", 106).
-spec attach(
    binary(),
    list(event()),
    fun((list(event()), gleam@dict:dict(gleam@erlang@atom:atom_(), gleam@dynamic:dynamic_()), gleam@dict:dict(binary(), gleam@dynamic:dynamic_()), list(any())) -> nil),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/telemetry.gleam", 124).
