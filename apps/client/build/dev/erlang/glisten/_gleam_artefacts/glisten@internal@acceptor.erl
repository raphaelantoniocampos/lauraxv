...
-type pool(PUL, PUM) :: {pool,
        fun((glisten@internal@handler:loop_message(PUL), PUM, glisten@internal@handler:connection(PUL)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(PUL), PUM)),
        integer(),
        fun((glisten@internal@handler:connection(PUL)) -> {PUM,
            gleam@option:option(gleam@erlang@process:selector(PUL))}),
        gleam@option:option(fun((PUM) -> nil)),
        glisten@transport:transport()}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/acceptor.gleam", 38).
-spec start(
    pool(any(), any()),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glisten/src/glisten/internal/acceptor.gleam", 123).
-spec start_pool(
    pool(any(), any()),
    glisten@transport:transport(),
    integer(),
