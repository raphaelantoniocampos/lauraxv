...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 227).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 250).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 29).
-spec request(
    gleam@http:method(),
    binary(),
    list({binary(), binary()}),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 57).
-spec get(binary(), list({binary(), binary()})) -> gleam@http@request:request(wisp@internal:connection()).
get(Path, Headers) ->
    request(get, Path, Headers, <<>>).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 63).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 72).
-spec post_form(
    binary(),
    list({binary(), binary()}),
    list({binary(), binary()})
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 86).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 98).
-spec head(binary(), list({binary(), binary()})) -> gleam@http@request:request(wisp@internal:connection()).
head(Path, Headers) ->
    request(head, Path, Headers, <<>>).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 104).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 113).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 127).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 135).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 144).
-spec delete_form(
    binary(),
    list({binary(), binary()}),
    list({binary(), binary()})
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 158).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 170).
-spec trace(binary(), list({binary(), binary()})) -> gleam@http@request:request(wisp@internal:connection()).
trace(Path, Headers) ->
    request(trace, Path, Headers, <<>>).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 176).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 182).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 188).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 196).
-spec patch_form(
    binary(),
    list({binary(), binary()}),
    list({binary(), binary()})
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 210).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/wisp/src/wisp/testing.gleam", 278).
-spec set_cookie(
    gleam@http@request:request(wisp@internal:connection()),
    binary(),
    binary(),
