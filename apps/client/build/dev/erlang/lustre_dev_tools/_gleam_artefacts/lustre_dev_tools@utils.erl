...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/utils.gleam", 6).
-spec term_width() -> integer().
term_width() ->
    _pipe = term_size:columns(),
    gleam@result:unwrap(_pipe, 80).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/utils.gleam", 66).
-spec do_shorten(
    list(binary()),
    list(binary()),
    boolean(),
...
do_shorten(Left, Right, Shortened, From, Current_length, Max_length) ->
    case {Current_length =< Max_length, Left, Right, From} of
        ...
        {_, [Dropped | Left@2], Right@2, left} ->
            New_length = Current_length - gleam@string:length(Dropped),
            do_shorten(Left@2, Right@2, true, right, New_length, Max_length);

        {_, Left@3, [Dropped@1 | Right@3], right} ->
            New_length@1 = Current_length - gleam@string:length(Dropped@1),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/utils.gleam", 31).
...
shorten(Strings, Max_length) ->
    Initial_length = gleam@list:fold(
        Strings,
        0,
        fun(Acc, String) -> Acc + gleam@string:length(String) end
    ),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/utils.gleam", 11).
