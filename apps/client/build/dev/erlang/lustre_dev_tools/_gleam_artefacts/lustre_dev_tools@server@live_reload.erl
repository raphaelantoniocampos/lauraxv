...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 69).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 80).
-spec init_socket(
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 95).
-spec loop_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())},
    mist@internal@websocket:websocket_connection(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 132).
-spec close_socket(
    {gleam@erlang@process:subject(socket_msg()),
        gleam@erlang@process:subject(watcher_msg())}
) -> nil.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 195).
-spec loop_watcher(
    watcher_msg(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 265).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 249).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 150).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 138).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/lustre_dev_tools/src/lustre_dev_tools/server/live_reload.gleam", 54).
