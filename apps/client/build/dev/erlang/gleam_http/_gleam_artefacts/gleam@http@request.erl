...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 31).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 45).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 76).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 87).
-spec set_header(request(KHC), binary(), binary()) -> request(KHC).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 104).
-spec prepend_header(request(KHF), binary(), binary()) -> request(KHF).
prepend_header(Request, Key, Value) ->
    Headers = [{gleam@string:lowercase(Key), Value} |
        erlang:element(3, Request)],
    erlang:setelement(3, Request, Headers).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 116).
-spec set_body(request(any()), KHK) -> request(KHK).
set_body(Req, Body) ->
    {request, Method, Headers, _, Scheme, Host, Port, Path, Query} = Req,
    {request, Method, Headers, Body, Scheme, Host, Port, Path, Query}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 141).
-spec map(request(KHM), fun((KHM) -> KHO)) -> request(KHO).
map(Request, Transform) ->
    _pipe = erlang:element(4, Request),
    _pipe@1 = Transform(_pipe),
    set_body(Request, _pipe@1).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 161).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 167).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 177).
-spec set_query(request(KHY), list({binary(), binary()})) -> request(KHY).
set_query(Req, Query) ->
    Pair = fun(T) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 200).
-spec set_method(request(KIC), gleam@http:method()) -> request(KIC).
set_method(Req, Method) ->
    erlang:setelement(2, Req, Method).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 207).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 222).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 230).
-spec set_scheme(request(KIJ), gleam@http:scheme()) -> request(KIJ).
set_scheme(Req, Scheme) ->
    erlang:setelement(5, Req, Scheme).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 236).
-spec set_host(request(KIM), binary()) -> request(KIM).
set_host(Req, Host) ->
    erlang:setelement(6, Req, Host).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 242).
-spec set_port(request(KIP), integer()) -> request(KIP).
set_port(Req, Port) ->
    erlang:setelement(7, Req, {some, Port}).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 248).
-spec set_path(request(KIS), binary()) -> request(KIS).
set_path(Req, Path) ->
    erlang:setelement(8, Req, Path).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 255).
-spec set_cookie(request(KIV), binary(), binary()) -> request(KIV).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 274).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_http/src/gleam/http/request.gleam", 292).
-spec remove_cookie(request(KJA), binary()) -> request(KJA).
