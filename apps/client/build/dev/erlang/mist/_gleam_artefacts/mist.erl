...
-opaque builder(YPS, YPT) :: {builder,
        integer(),
        fun((gleam@http@request:request(YPS)) -> gleam@http@response:response(YPT)),
...
-type websocket_message(YPU) :: {text, binary()} |
    {binary, bitstring()} |
    closed |
    shutdown |
    {custom, YPU}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 54).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 66).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 102).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 116).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 146).
-spec read_body(
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 175).
-spec do_stream(
    gleam@http@request:request(mist@internal@http:connection()),
    mist@internal@buffer:buffer()
) -> fun((integer()) -> {ok, chunk()} | {error, read_error()}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 240).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 220).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 292).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 341).
-spec new(
    fun((gleam@http@request:request(YQR)) -> gleam@http@response:response(YQT))
) -> builder(YQR, YQT).
new(Handler) ->
    {builder,
        4000,
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 353).
-spec port(builder(YQX, YQY), integer()) -> builder(YQX, YQY).
port(Builder, Port) ->
    erlang:setelement(2, Builder, Port).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 360).
-spec read_request_body(
    builder(bitstring(), YRD),
    integer(),
    gleam@http@response:response(YRD)
) -> builder(mist@internal@http:connection(), YRD).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 376).
-spec after_start(
    builder(YRJ, YRK),
    fun((integer(), gleam@http:scheme()) -> nil)
) -> builder(YRJ, YRK).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 383).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 409).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 413).
-spec get_port(server()) -> integer().
get_port(Server) ->
    erlang:element(3, Server).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 428).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 418).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 487).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 475).
-spec start_https(
    builder(mist@internal@http:connection(), response_data()),
    binary(),
    binary()
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 539).
-spec internal_to_public_ws_message(
    mist@internal@websocket:handler_message(YSK)
) -> {ok, websocket_message(YSK)} | {error, nil}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 564).
-spec websocket(
    gleam@http@request:request(mist@internal@http:connection()),
    fun((YSQ, mist@internal@websocket:websocket_connection(), websocket_message(YSR)) -> gleam@otp@actor:next(YSR, YSQ)),
    fun((mist@internal@websocket:websocket_connection()) -> {YSQ,
        gleam@option:option(gleam@erlang@process:selector(YSR))}),
    fun((YSQ) -> nil)
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 617).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 641).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 679).
-spec event(gleam@string_builder:string_builder()) -> sse_event().
event(Data) ->
    {sse_event, none, none, Data}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 684).
-spec event_id(sse_event(), binary()) -> sse_event().
event_id(Event, Id) ->
    erlang:setelement(2, Event, {some, Id}).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 689).
-spec event_name(sse_event(), binary()) -> sse_event().
event_name(Event, Name) ->
    erlang:setelement(3, Event, {some, Name}).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 702).
-spec server_sent_events(
    gleam@http@request:request(mist@internal@http:connection()),
    gleam@http@response:response(any()),
    fun(() -> gleam@otp@actor:init_result(YTF, YTG)),
    fun((YTG, sse_connection(), YTF) -> gleam@otp@actor:next(YTG, YTF))
) -> gleam@http@response:response(response_data()).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist.gleam", 747).
