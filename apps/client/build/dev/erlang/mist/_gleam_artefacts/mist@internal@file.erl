...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/file.gleam", 33).
-spec sendfile(
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/file.gleam", 75).
-spec open(bitstring()) -> {ok, file_descriptor()} | {error, file_error()}.
open(File) ->
    mist_ffi:file_open(File).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/file.gleam", 24).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/file.gleam", 81).
