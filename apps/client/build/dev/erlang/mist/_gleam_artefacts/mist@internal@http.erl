...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 76).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 111).
-spec read_data(
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 238).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 510).
-spec add_date_header(gleam@http@response:response(WIB)) -> gleam@http@response:response(WIB).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 517).
-spec connection_close(gleam@http@response:response(WIE)) -> gleam@http@response:response(WIE).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 521).
-spec keep_alive(gleam@http@response:response(WIH)) -> gleam@http@response:response(WIH).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 525).
-spec maybe_keep_alive(gleam@http@response:response(WIK)) -> gleam@http@response:response(WIK).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 532).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(WIN)) -> gleam@http@response:response(WIN)).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 552).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 573).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 581).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 82).
-spec parse_headers(
    bitstring(),
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 602).
-spec crypto_hash(sha_hash(), binary()) -> binary().
crypto_hash(Hash, Data) ->
    crypto:hash(Hash, Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 605).
-spec base64_encode(binary()) -> binary().
base64_encode(Data) ->
    base64:encode(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 144).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 251).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 174).
-spec read_chunk(
    glisten@socket:socket(),
    glisten@transport:transport(),
    mist@internal@buffer:buffer(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 357).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 440).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 447).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http.gleam", 487).
-spec upgrade(
    glisten@socket:socket(),
    glisten@transport:transport(),
    list(binary()),
