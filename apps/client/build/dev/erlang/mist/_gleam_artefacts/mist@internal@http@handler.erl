...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 27).
-spec initial_state() -> state().
initial_state() ->
    {state, none}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 68).
-spec log_and_error(
    gleam@erlang:crash(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 102).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 160).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 220).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 247).
-spec int_to_hex(integer()) -> binary().
int_to_hex(Int) ->
    erlang:integer_to_list(Int, 16).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 122).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/mist/src/mist/internal/http/handler.gleam", 31).
-spec call(
    gleam@http@request:request(mist@internal@http:connection()),
