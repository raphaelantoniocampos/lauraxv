...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 30).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 204).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 212).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 242).
-spec make_frame(
    integer(),
    integer(),
    bitstring(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 165).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 184).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 269).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 279).
-spec to_text_frame(
    binary(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 297).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 327).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 343).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 389).
-spec inflate(
    boolean(),
    gleam@option:option(gramps@websocket@compression:context()),
    bitstring()
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 63).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 314).
-spec get_messages(
    bitstring(),
    list(parsed_frame()),
    gleam@option:option(gramps@websocket@compression:context())
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 405).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gramps/src/gramps/websocket.gleam", 376).
