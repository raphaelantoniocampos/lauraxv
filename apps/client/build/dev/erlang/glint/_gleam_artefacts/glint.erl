...
-opaque glint(NPB) :: {glint, config(), command_node(NPB)}.

-type args_count() :: {eq_args, integer()} | {min_args, integer()}.

-opaque command(NPC) :: {command,
        fun((named_args(), list(binary()), flags()) -> NPC),
        flags(),
        binary(),
        gleam@option:option(args_count()),
        list(binary())}.

-type internal_command(NPD) :: {internal_command,
        fun((named_args(), list(binary()), flags()) -> NPD),
        flags(),
        gleam@option:option(args_count()),
        list(binary())}.
...
-type command_node(NPE) :: {command_node,
        gleam@option:option(internal_command(NPE)),
        gleam@dict:dict(binary(), command_node(NPE)),
        flags(),
        binary()}.

-type out(NPF) :: {out, NPF} | {help, binary()}.
...
-opaque flag(NPG) :: {flag,
        binary(),
        binary(),
        fun((binary()) -> {ok, NPG} | {error, snag:snag()}),
        fun((flag_internals(NPG)) -> value()),
        fun((flags(), binary()) -> {ok, NPG} | {error, snag:snag()}),
        gleam@option:option(NPG)}.

-type flag_internals(NPH) :: {flag_internals,
        gleam@option:option(NPH),
        fun((binary()) -> {ok, NPH} | {error, snag:snag()})}.

-type flag_entry() :: {flag_entry, value(), binary()}.

-opaque flags() :: {flags, gleam@dict:dict(binary(), flag_entry())}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 61).
-spec config(glint(NPO), config()) -> glint(NPO).
config(Glint, Config) ->
    erlang:setelement(2, Glint, Config).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 69).
-spec pretty_help(glint(NPR), pretty_help()) -> glint(NPR).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 77).
-spec with_name(glint(NPU), binary()) -> glint(NPU).
with_name(Glint, Name) ->
    config(Glint, erlang:setelement(3, erlang:element(2, Glint), {some, Name})).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 85).
-spec without_exit(glint(NPX)) -> glint(NPX).
without_exit(Glint) ->
    erlang:setelement(
        2,
        Glint,
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 93).
-spec as_module(glint(NQA)) -> glint(NQA).
as_module(Glint) ->
    config(Glint, erlang:setelement(4, erlang:element(2, Glint), true)).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 102).
-spec with_indent_width(glint(NQD), integer()) -> glint(NQD).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 110).
-spec with_max_output_width(glint(NQG), integer()) -> glint(NQG).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 118).
-spec with_min_first_column_width(glint(NQJ), integer()) -> glint(NQJ).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 126).
-spec with_column_gap(glint(NQM), integer()) -> glint(NQM).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 243).
-spec global_help(glint(NQV), binary()) -> glint(NQV).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 292).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 329).
-spec command_help(binary(), fun(() -> command(NRK))) -> command(NRK).
command_help(Desc, F) ->
    erlang:setelement(4, F(), Desc).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 348).
-spec unnamed_args(args_count(), fun(() -> command(NRN))) -> command(NRN).
unnamed_args(Count, F) ->
    erlang:setelement(5, F(), {some, Count}).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 376).
-spec named_arg(
    binary(),
    fun((fun((named_args()) -> binary())) -> command(NRQ))
) -> command(NRQ).
named_arg(Name, F) ->
    Cmd = (F(
        fun(Named_args) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 515).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 635).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 710).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 737).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 886).
-spec new_builder(
    binary(),
    fun((flag_internals(NUF)) -> value()),
    fun((flags(), binary()) -> {ok, NUF} | {error, snag:snag()}),
    fun((binary()) -> {ok, NUF} | {error, snag:snag()})
) -> flag(NUF).
new_builder(Name, Valuer, Getter, P) ->
    {flag, Name, <<""/utf8>>, P, Valuer, Getter, none}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 904).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 957).
-spec attempt(
    {ok, NUX} | {error, NUY},
    fun((NUX) -> {ok, any()} | {error, NUY})
) -> {ok, NUX} | {error, NUY}.
attempt(Val, F) ->
    gleam@result:'try'(Val, fun(A) -> gleam@result:replace(F(A), A) end).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 950).
-spec wrap_with_constraint(
    fun((binary()) -> {ok, NUR} | {error, snag:snag()}),
    fun((NUR) -> {ok, NUR} | {error, snag:snag()})
) -> fun((binary()) -> {ok, NUR} | {error, snag:snag()}).
wrap_with_constraint(P, Constraint) ->
    fun(Input) -> attempt(P(Input), Constraint) end.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 941).
-spec flag_constraint(flag(NUN), fun((NUN) -> {ok, NUN} | {error, snag:snag()})) -> flag(NUN).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 986).
-spec flag_help(flag(NVG), binary()) -> flag(NVG).
flag_help(Flag, Description) ->
    erlang:setelement(3, Flag, Description).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 999).
-spec flag_default(flag(NVJ), NVJ) -> flag(NVJ).
flag_default(Flag, Default) ->
    erlang:setelement(7, Flag, {some, Default}).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1009).
-spec insert(flags(), binary(), flag_entry()) -> flags().
insert(Flags, Name, Flag) ->
    {flags, gleam@dict:insert(erlang:element(2, Flags), Name, Flag)}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 410).
-spec flag(
    flag(NRT),
    fun((fun((flags()) -> {ok, NRT} | {error, snag:snag()})) -> command(NRW))
) -> command(NRW).
flag(Flag, F) ->
    Cmd = F(
        fun(_capture) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1013).
-spec merge(flags(), flags()) -> flags().
merge(A, B) ->
    {flags, gleam@dict:merge(erlang:element(2, A), erlang:element(2, B))}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1017).
-spec fold(flags(), NVM, fun((NVM, binary(), flag_entry()) -> NVM)) -> NVM.
fold(Flags, Acc, F) ->
    gleam@dict:fold(erlang:element(2, Flags), Acc, F).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 724).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 680).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1021).
-spec new_flags() -> flags().
new_flags() ->
    {flags, gleam@dict:new()}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 281).
-spec empty_command() -> command_node(any()).
empty_command() ->
    {command_node, none, gleam@dict:new(), new_flags(), <<""/utf8>>}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 311).
-spec command(fun((named_args(), list(binary()), flags()) -> NRH)) -> command(NRH).
command(Runner) ->
    {command, Runner, new_flags(), <<""/utf8>>, none, []}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1072).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1076).
-spec flag_not_provided_error() -> {ok, any()} | {error, snag:snag()}.
flag_not_provided_error() ->
    snag:error(<<"no value provided"/utf8>>).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1080).
-spec construct_value(
    binary(),
    flag_internals(NVT),
    fun((flag_internals(NVT)) -> value())
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1091).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1106).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1110).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1116).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1122).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1131).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1038).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1051).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1136).
-spec get_value(
    flags(),
    binary(),
    fun((flag_entry()) -> {ok, NVZ} | {error, snag:snag()})
) -> {ok, NVZ} | {error, snag:snag()}.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1151).
-spec get_flag(flags(), flag(NWC)) -> {ok, NWC} | {error, snag:snag()}.
get_flag(Flags, Flag) ->
    (erlang:element(6, Flag))(Flags, erlang:element(2, Flag)).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1157).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 822).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1168).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 831).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1179).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 875).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1190).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 860).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1201).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 866).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1215).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 841).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1226).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 850).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1252).
-spec do_update_at(
    command_node(NWV),
    list(binary()),
    fun((command_node(NWV)) -> command_node(NWV))
) -> command_node(NWV).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1241).
-spec update_at(
    glint(NWP),
    list(binary()),
    fun((command_node(NWP)) -> command_node(NWP))
) -> glint(NWP).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 223).
-spec path_help(glint(NQR), list(binary()), binary()) -> glint(NQR).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 261).
-spec add(glint(NQY), list(binary()), command(NQY)) -> glint(NQY).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 421).
-spec group_flag(glint(NRZ), list(binary()), flag(any())) -> glint(NRZ).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 213).
-spec new() -> glint(any()).
new() ->
    {glint,
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 661).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 650).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 1029).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 529).
-spec execute_root(
    list(binary()),
    config(),
    command_node(NSV),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 464).
-spec do_execute(
    command_node(NSL),
    config(),
    list(binary()),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 445).
-spec execute(glint(NSF), list(binary())) -> {ok, out(NSF)} | {error, binary()}.
execute(Glint, Args) ->
    Help_flag = <<"--"/utf8,
        (erlang:element(
            2,
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 606).
-spec run_and_handle(glint(NTF), list(binary()), fun((NTF) -> any())) -> nil.
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/glint/src/glint.gleam", 596).
