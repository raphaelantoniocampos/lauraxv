...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 29).
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 38).
-spec unsafe_coerce(dynamic_()) -> any().
unsafe_coerce(A) ->
    gleam_stdlib:identity(A).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 52).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 73).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 120).
-spec put_expected(decode_error(), binary()) -> decode_error().
put_expected(Error, Expected) ->
    erlang:setelement(2, Error, Expected).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 131).
-spec classify(dynamic_()) -> binary().
classify(Data) ->
    gleam_stdlib:classify_dynamic(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 154).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 177).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 200).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 226).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 369).
-spec optional(fun((dynamic_()) -> {ok, DOY} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DOY)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 504).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1034).
-spec any(list(fun((dynamic_()) -> {ok, DSY} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        DSY} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1530).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1067).
-spec decode1(
    fun((DTC) -> DTD),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 576).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 261).
-spec result(
    fun((dynamic_()) -> {ok, DOM} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DOO} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, DOM} | {error, DOO}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 314).
-spec list(fun((dynamic_()) -> {ok, DOT} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DOT)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 100).
-spec map_errors(
    {ok, DNH} | {error, list(decode_error())},
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 108).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 96).
-spec string(dynamic_()) -> {ok, binary()} | {error, list(decode_error())}.
string(Data) ->
    decode_string(Data).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 398).
-spec field(
    any(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 440).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DPM} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DPM)} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 483).
-spec element(
    integer(),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 566).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 642).
-spec tuple2(
    fun((dynamic_()) -> {ok, DQU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DQW} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DQU, DQW}} | {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 711).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {DQZ, DRB, DRD}} | {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 782).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {DRG, DRI, DRK, DRM}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 855).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {DRP, DRR, DRT, DRV, DRX}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 930).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {DSA, DSC, DSE, DSG, DSI, DSK}} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 981).
-spec dict(
    fun((dynamic_()) -> {ok, DSN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DSP} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(DSN, DSP)} |
    {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1095).
-spec decode2(
    fun((DTG, DTH) -> DTI),
    fun((dynamic_()) -> {ok, DTG} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DTH} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DTI} | {error, list(decode_error())}).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1127).
-spec decode3(
    fun((DTM, DTN, DTO) -> DTP),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1173).
-spec decode4(
    fun((DTU, DTV, DTW, DTX) -> DTY),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1229).
-spec decode5(
    fun((DUE, DUF, DUG, DUH, DUI) -> DUJ),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1289).
-spec decode6(
    fun((DUQ, DUR, DUS, DUT, DUU, DUV) -> DUW),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1354).
-spec decode7(
    fun((DVE, DVF, DVG, DVH, DVI, DVJ, DVK) -> DVL),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1423).
-spec decode8(
    fun((DVU, DVV, DVW, DVX, DVY, DVZ, DWA, DWB) -> DWC),
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/dynamic.gleam", 1496).
-spec decode9(
    fun((DWM, DWN, DWO, DWP, DWQ, DWR, DWS, DWT, DWU) -> DWV),
    ...
    fun((dynamic_()) -> {ok, DWS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DWT} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DWU} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DWV} | {error, list(decode_error())}).
