...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 116).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 126).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 137).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 178).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 173).
-spec pad_list(list(gleam@option:option(FKN)), integer()) -> list(gleam@option:option(FKN)).
pad_list(List, Size) ->
    _pipe = List,
    lists:append(_pipe, gleam@list:repeat(none, extra_required(List, Size))).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 145).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 56).
-spec parse(binary()) -> {ok, uri()} | {error, nil}.
parse(Uri_string) ->
    gleam_stdlib:uri_parse(Uri_string).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 198).
-spec parse_query(binary()) -> {ok, list({binary(), binary()})} | {error, nil}.
parse_query(Query) ->
    gleam_stdlib:parse_query(Query).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 242).
-spec percent_encode(binary()) -> binary().
percent_encode(Value) ->
    gleam_stdlib:percent_encode(Value).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 225).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 217).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 259).
-spec percent_decode(binary()) -> {ok, binary()} | {error, nil}.
percent_decode(Value) ->
    gleam_stdlib:percent_decode(Value).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 267).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 286).
-spec remove_dot_segments(list(binary())) -> list(binary()).
remove_dot_segments(Input) ->
    do_remove_dot_segments(Input, []).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 302).
-spec path_segments(binary()) -> list(binary()).
path_segments(Path) ->
    remove_dot_segments(gleam@string:split(Path, <<"/"/utf8>>)).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 318).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 362).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 381).
-spec drop_last(list(FLN)) -> list(FLN).
drop_last(Elements) ->
    gleam@list:take(Elements, erlang:length(Elements) - 1).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 385).
-spec join_segments(list(binary())) -> binary().
join_segments(Segments) ->
    gleam@string:join([<<""/utf8>> | Segments], <<"/"/utf8>>).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/uri.gleam", 395).
