...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 24).
-spec is_empty(binary()) -> boolean().
is_empty(Str) ->
    Str =:= <<""/utf8>>.

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 50).
-spec length(binary()) -> integer().
length(String) ->
    string:length(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 75).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 70).
-spec reverse(binary()) -> binary().
reverse(String) ->
    do_reverse(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 104).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 127).
-spec lowercase(binary()) -> binary().
lowercase(String) ->
    string:lowercase(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 147).
-spec uppercase(binary()) -> binary().
uppercase(String) ->
    string:uppercase(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 171).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 254).
-spec crop(binary(), binary()) -> binary().
crop(String, Substring) ->
    gleam_stdlib:crop_string(String, Substring).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 309).
-spec contains(binary(), binary()) -> boolean().
contains(Haystack, Needle) ->
    gleam_stdlib:contains_string(Haystack, Needle).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 320).
-spec starts_with(binary(), binary()) -> boolean().
starts_with(String, Prefix) ->
    gleam_stdlib:string_starts_with(String, Prefix).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 337).
-spec ends_with(binary(), binary()) -> boolean().
ends_with(String, Suffix) ->
    gleam_stdlib:string_ends_with(String, Suffix).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 389).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 381).
-spec split_once(binary(), binary()) -> {ok, {binary(), binary()}} |
    {error, nil}.
split_once(X, Substring) ->
    do_split_once(X, Substring).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 412).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 432).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 449).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 472).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 467).
-spec join(list(binary()), binary()) -> binary().
join(Strings, Separator) ->
    do_join(Strings, Separator).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 561).
-spec do_trim(binary()) -> binary().
do_trim(String) ->
    string:trim(String, both).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 556).
-spec trim(binary()) -> binary().
trim(String) ->
    do_trim(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 588).
-spec do_trim_left(binary()) -> binary().
do_trim_left(String) ->
    string:trim(String, leading).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 583).
-spec trim_left(binary()) -> binary().
trim_left(String) ->
    do_trim_left(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 606).
-spec do_trim_right(binary()) -> binary().
do_trim_right(String) ->
    string:trim(String, trailing).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 601).
-spec trim_right(binary()) -> binary().
trim_right(String) ->
    do_trim_right(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 629).
-spec pop_grapheme(binary()) -> {ok, {binary(), binary()}} | {error, nil}.
pop_grapheme(String) ->
    gleam_stdlib:string_pop_grapheme(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 651).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 646).
-spec to_graphemes(binary()) -> list(binary()).
to_graphemes(String) ->
    _pipe = do_to_graphemes(String, []),
    lists:reverse(_pipe).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 216).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 265).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 281).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 354).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 538).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 497).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 525).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 699).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 693).
-spec do_to_utf_codepoints(binary()) -> list(integer()).
do_to_utf_codepoints(String) ->
    _pipe = do_to_utf_codepoints_impl(<<String/binary>>, []),
    lists:reverse(_pipe).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 688).
-spec to_utf_codepoints(binary()) -> list(integer()).
to_utf_codepoints(String) ->
    do_to_utf_codepoints(String).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 739).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 745).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 764).
-spec utf_codepoint_to_int(integer()) -> integer().
utf_codepoint_to_int(Cp) ->
    gleam_stdlib:identity(Cp).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 787).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 810).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 833).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 851).
...
-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 860).
-spec inspect(any()) -> binary().
inspect(Term) ->
    _pipe = gleam_stdlib:inspect(Term),
    gleam@string_builder:to_string(_pipe).

-file("/home/raphaelac/repositories/lauraxv/client/build/packages/gleam_stdlib/src/gleam/string.gleam", 883).
