...
export function send_hpack_context(state, context) {
  return state.withFields({ send_hpack_context: context });
}

export function receive_hpack_context(state, context) {
  return state.withFields({ receive_hpack_context: context });
}

export function append_data(state, data) {
  return state.withFields({
    frame_buffer: $buffer.append(state.frame_buffer, data)
  });
}
